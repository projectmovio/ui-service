        ...
        <div class="col-md-9 col-7">
            ...
            <div class="card mt-2 col-7 col-md-3">
               ...
               <div class="card-body p-1">
                  <a class="${previousEpisode === '' ? 'd-none' : ''}" href="/episode/?collection_name=${collectionName}&id=${id}&episode_id=${previousEpisode}"><i class="fas fa-arrow-alt-circle-left"></i></a>
                  <a class="${nextEpisode === '' ? 'd-none' : ''}" href="/episode/?collection_name=${collectionName}&id=${id}&episode_id=${nextEpisode}"><i class="fas fa-arrow-alt-circle-right"></i></a>
                </div>
              </div>
            </div>
        </div>
