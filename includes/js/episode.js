        ...
        <div class="col-md-4 col-10 mt-1">
            ...
            <div class="input-group input-group-sm pt-1">
              ...
              <div class="input-group-append">
                <button class="btn btn-primary" type="button" onclick="setCurrentWatchDate()" data-toggle="tooltip" data-html="true" data-placement="top" title="Set today date"><i class="fas fa-calendar-day"></i></button><button class="btn btn-danger" type="button" onclick="removeWatchDate()" data-toggle="tooltip" data-html="true" data-placement="top" title="Remove saved date"><i class="far fa-calendar-times"></i></button>
              </div>
            </div>
        </div>
    `;
